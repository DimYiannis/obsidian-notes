...
Personal knowledge base. Each folder is a separate Obsidian vault.

## Vaults

- **llm-wiki** — LLM second brain: concept/entity/source wiki maintained with Claude. Schema in `llm-wiki/CLAUDE.md`.
...
Open a folder as a vault in Obsidian. Wikilinks resolve within a vault only.
